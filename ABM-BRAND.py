...
ua = random.choice([
    ...
    ua_galaxys10,
    ua_lenovo])
logo = "\n\x1b[1;93m'##:::'##:'##::::'##::::'###::::'##::: ##:\n ##::'##:: ##:::: ##:::'## ##::: ###:: ##:\n\x1b[1;91m ##:'##::: ##:::: ##::'##:. ##:: ####: ##:\n\x1b[1;93m #####:::: #########:'##:::. ##: ## ## ##:\n\x1b[1;92m ##. ##::: ##.... ##: #########: ##. ####:\n\x1b[1;91m ##:. ##:: ##:::: ##: ##.... ##: ##:. ###:\n\x1b[1;93m ##::. ##: ##:::: ##: ##:::: ##: ##::. ##:\x1b[1;91m ------------------------------------------\n\x1b[0;91m\x1b[1;43m                 MAKE FILE :)                 \x1b[0m\n-----------------------------------------------\n\x1b[0;91m \x1a OWNERS : Mahin KHAN ~ \xc9\x98v\xc9\xa9\xc9\xad D'\xc9\xad\xc9\x98w\xc9\xa9x \n\x1b[0;97m \x1a Github : MahinXKhan\n\x1b[0;91m \x1a Note   : Use Only Kiwi Browser Token"
...
def login():
    ...
    try:
        ...
        print '%s[%s*%s]%s WelCome To Mahin %s %s' % (B, P, B, P, H, xwx['name'].lower())
...
def menu():
    ...
    print '\x1b[1;91mExample: /sdcard/mahin.txt'
    print ''
